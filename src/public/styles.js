...
.action_button{display:block;text-align:center;border-radius:10px;padding:6px;margin-bottom:10px;cursor:pointer;outline:0 solid;border:0;box-shadow:0 5px 5px rgba(0,0,0,0.1)}
...
.action_button{background-color:#FFF}
...
.action_button{background-color:#202C33}
