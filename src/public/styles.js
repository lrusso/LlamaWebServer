...
.action_button{display:block;text-align:center;border:1px solid #A0A0A0;height:40px;background-color:#C8C8C8;border-radius:5px;padding-left:12px;padding-right:12px;cursor:pointer;outline:0px solid #C8C8C8}
...
.reply{margin-bottom:10px;background-color:white;word-break:break-word;box-shadow:0 5px 5px rgba(0,0,0,0.1)}
...
.reply{margin-bottom:10px;background-color:#202c33 !important;color:white !important;word-break:break-word}
