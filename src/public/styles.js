...
.agent_image{float:left;background-color:white;margin-left:15px;margin-right:15px;border-radius:20px;width:40px;height:40px;background-image:url(app.png);background-size:40px 40px;background-repeat:no-repeat;border:1px solid #E3E4E6}
...
.agent_container{position:fixed;left:0;right:0;top:0;height:64px;display:flex;align-items:center}
.agent_image{float:left;background-color:white;margin-left:15px;margin-right:15px;border-radius:20px;width:40px;height:40px;background-image:url(app.png);background-size:40px 40px;background-repeat:no-repeat;border:1px solid #353F46}
