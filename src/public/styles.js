...
html,body{margin:0;padding:0;overscroll-behavior:none;overflow-anchor:none}
...
.input_textbox::placeholder{color:rgba(0,0,0,0.4);opacity:1}
...
.input_textbox::placeholder{color:rgba(206,206,206,0.25);opacity:1}
