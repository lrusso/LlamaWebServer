...
#inputbox{position:fixed;left:0;right:0;bottom:9px;margin-left:10px;margin-right:10px;border:0 solid white;border-radius:16px;padding:14px;resize:none;outline:none;font-size:16px}
#inputbox::placeholder{opacity:0.4}
#inputbox:disabled{background-color:#ececec}
.action_button{display:block;text-align:center;border:1px solid #A0A0A0;height:40px;background-color:#C8C8C8;border-radius:5px;margin-top:10px;padding-left:12px;padding-right:12px;cursor:pointer;outline:0px solid #C8C8C8}
...
.prompt{margin-left:10px;margin-top:10px;margin-bottom:10px;text-align:right;word-break:break-word}
.prompt_background{background-color:#d9fdd3 !important;box-shadow:0 5px 5px rgba(0,0,0,0.1)}
.reply{background-color:white;word-break:break-word;box-shadow:0 5px 5px rgba(0,0,0,0.1)}
...
#inputbox{position:fixed;left:0;right:0;bottom:9px;margin-left:10px;margin-right:10px;border:0 solid white;border-radius:16px;padding:14px;resize:none;outline:none;font-size:16px;background-color:#121317;color:white}
#inputbox::placeholder{opacity:0.4}
#inputbox:disabled{background-color:#282b34}
.action_button{display:block;text-align:center;border:1px solid #616266;height:40px;background-color:#545b6d;border-radius:5px;margin-top:10px;padding-left:12px;padding-right:12px;cursor:pointer;outline:0px solid #858da2;color:white}
...
.reply{background-color:#202c33 !important;color:white !important;word-break:break-word}
