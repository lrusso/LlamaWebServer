...
.agent_image{float:left;background-color:white;margin-left:15px;margin-right:15px;border-radius:20px;width:40px;height:40px;background-image:url(agent.png);background-size:40px 40px;background-repeat:no-repeat;border:1px solid rgba(206,206,206,0.4)}
...
.agent_container{position:fixed;left:0;right:0;top:0;height:64px;display:flex;align-items:center}
.agent_image{float:left;background-color:white;margin-left:15px;margin-right:15px;border-radius:20px;width:40px;height:40px;background-image:url(agent.png);background-size:40px 40px;background-repeat:no-repeat;border:1px solid rgba(0,0,0,0.8)}
